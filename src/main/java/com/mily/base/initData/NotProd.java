    ...
    public ApplicationRunner init() {
        return args -> {
            ...
            if (mu.isEmpty()) {
                ...
                MilyUser milyUser4 = milyUserService.userSignup("lawyer01", "lawyer01", "윤준혁", "lawyer01@email.com", "01036842971", "1996-01-01").getData();
                milyUserService.lawyerSignup("형사", "형사 사건 전문 변호사 윤준혁입니다.", "대전 서구 대덕대로 179, 밀리스 빌딩 9층 A 사무실", "25-190172-1521", "대전", milyUser4);
                MilyUser milyUser5 = milyUserService.userSignup("lawyer02", "lawyer02", "조겨울샘", "lawyer02@email.com", "01076194376", "1995-01-01").getData();
                milyUserService.lawyerSignup("민사", "안녕하세요. 변호사 조겨울샘입니다.", "대전 서구 대덕대로 179, 밀리스 빌딩 9층 A 사무실", "25-200341-1521", "대전", milyUser5);
